...
%
    m_{20}^{(1)*} + m_{02}^{(1)*}
    & = (1-\omega_2) (m_{20}^{(1)} + m_{02}^{(1)}) + \omega_2 \frac{2 m_{00}}{3} \\
%
...
\Leftrightarrow
    ...
    & = (1-\omega_4)(m_{22}^{(1)} - \theta (m_{20}^{(1)} + m_{02}^{(1)}))
    \\&\quad
    + \theta ((1-\omega_2) (m_{20}^{(1)} + m_{02}^{(1)}) + \omega_2 \frac{2 m_{00}}{3}) .
  \end{aligned}
\end{equation}
...
\begin{equation}
  \begin{aligned}
    ...
    m_{21}^{(1)*} & = \theta m_{01}^{(1)*} \\
    m_{12}^{(1)*} & = \theta m_{10}^{(1)*} \\
    m_{22}^{(1)*} & = \theta (m_{20}^{(1)*} + m_{02}^{(1)*}) = \theta \frac{2 m_{00}}{3}
  \end{aligned}
\end{equation}
