...
Another observation is, that, the ideal gas law should hold, connecting pressure and density through a to be determined factor, $\theta$:
\begin{equation}
  \label{eq: ideal gas}
  \theta m_{00} = m_{20} = m_{02}.
\end{equation}
