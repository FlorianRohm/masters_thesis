...
Hence,
\begin{equation}
  \label{eq:alternative representation of cumulants}
...
We seek a representation of the cumulants $\kappa_{\alpha\beta}$ in terms of moments, as the later ones are much more easy to compute, cfg.~\eqref{eq:Definition of moments}. This link can be established with the chain rule for differentiaton.
...
\begin{equation*}
  ...
  \end{aligned}
\end{equation*}
The cumulant $\kappa_{01}$ follows from symmetrie and is listed in~\ref{sub:Listing the cumulants from moments}
