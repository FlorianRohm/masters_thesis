...
\begin{equation}
  ...
  \end{aligned}
\end{equation}
From here on, we have to consider our specific collision. To do so, we have to look at the series expansion of the cumulants and relate them to the moments. Therefore, we have to expand all terms in~\eqref{eq: K_11 from moments} and following.
\begin{equation}
  \begin{aligned}
  ...
  \end{aligned}
\end{equation}
Now is a good time to fix the frame of reference for this analysis. As we'll see, the analysis will get way more easy when we choose a moving frame of reference which produces
\begin{equation}
  \label{eq: frame of reference}
  \begin{aligned}
    m_{10}=m_{10}&=0, \\
    m_{10}^{(p)}=m_{10}^{(p)}&=0 \quad \forall p\geq0.
  \end{aligned}
\end{equation}
