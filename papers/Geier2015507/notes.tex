...
and~\eqref{eq:fast forward c_i pipe beta expanded} are now solved where~\eqref{eq:fast forward c_alpha beta matrix} becomes
\todo[inline]{incorporate the inverse mathematica code}
\begin{equation}
  \begin{pmatrix}
    c_{-1|\beta} \\
    c_{0|\beta} \\
...
\todo[inline]{incorporate the integration mathematica code} gives
\begin{equation}
