...
def distributionFromCentralMoments(u, k_000, k_001, k_002, k_010, k_011, k_012, k_020, k_021, k_022,
    ...
    f[0, 0, 1] =  k_00_0*(1 - uz**2)  - k_00_1*2*uz       - k_00_2
    f[0, 0, 0] = (k_00_0*(uz**2 - uz) + k_00_1*(2*uz - 1) + k_00_2) * 0.5
    f[0, 0, 2] = (k_00_0*(uz**2 + uz) + k_00_1*(2*uz + 1) + k_00_2) * 0.5
    f[0, 1, 1] =  k_01_0*(1 - uz**2)  - k_01_1*2*uz       - k_01_2
    f[0, 1, 0] = (k_01_0*(uz**2 - uz) + k_01_1*(2*uz - 1) + k_01_2) * 0.5
    f[0, 1, 2] = (k_01_0*(uz**2 + uz) + k_01_1*(2*uz + 1) + k_01_2) * 0.5
    f[0, 2, 1] =  k_02_0*(1 - uz**2)  - k_02_1*2*uz       - k_02_2
    f[0, 2, 0] = (k_02_0*(uz**2 - uz) + k_02_1*(2*uz - 1) + k_02_2) * 0.5
    f[0, 2, 2] = (k_02_0*(uz**2 + uz) + k_02_1*(2*uz + 1) + k_02_2) * 0.5
    f[1, 0, 1] =  k_10_0*(1 - uz**2)  - k_10_1*2*uz       - k_10_2
    f[1, 0, 0] = (k_10_0*(uz**2 - uz) + k_10_1*(2*uz - 1) + k_10_2) * 0.5
    f[1, 0, 2] = (k_10_0*(uz**2 + uz) + k_10_1*(2*uz + 1) + k_10_2) * 0.5
    f[1, 1, 1] =  k_11_0*(1 - uz**2)  - k_11_1*2*uz       - k_11_2
    f[1, 1, 0] = (k_11_0*(uz**2 - uz) + k_11_1*(2*uz - 1) + k_11_2) * 0.5
    f[1, 1, 2] = (k_11_0*(uz**2 + uz) + k_11_1*(2*uz + 1) + k_11_2) * 0.5
    f[1, 2, 1] =  k_12_0*(1 - uz**2)  - k_12_1*2*uz       - k_12_2
    f[1, 2, 0] = (k_12_0*(uz**2 - uz) + k_12_1*(2*uz - 1) + k_12_2) * 0.5
    f[1, 2, 2] = (k_12_0*(uz**2 + uz) + k_12_1*(2*uz + 1) + k_12_2) * 0.5
    f[2, 0, 1] =  k_20_0*(1 - uz**2)  - k_20_1*2*uz       - k_20_2
    f[2, 0, 0] = (k_20_0*(uz**2 - uz) + k_20_1*(2*uz - 1) + k_20_2) * 0.5
    f[2, 0, 2] = (k_20_0*(uz**2 + uz) + k_20_1*(2*uz + 1) + k_20_2) * 0.5
    f[2, 1, 1] =  k_21_0*(1 - uz**2)  - k_21_1*2*uz       - k_21_2
    f[2, 1, 0] = (k_21_0*(uz**2 - uz) + k_21_1*(2*uz - 1) + k_21_2) * 0.5
    f[2, 1, 2] = (k_21_0*(uz**2 + uz) + k_21_1*(2*uz + 1) + k_21_2) * 0.5
    f[2, 2, 1] =  k_22_0*(1 - uz**2)  - k_22_1*2*uz       - k_22_2
    f[2, 2, 0] = (k_22_0*(uz**2 - uz) + k_22_1*(2*uz - 1) + k_22_2) * 0.5
