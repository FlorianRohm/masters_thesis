...
def centralMomentFromDistribution(f, u):
    ux = u[0]
    uy = u[1]
    uz = u[2]
    ...
    k2_n1_10 = k1_n1n1_0*(n1-uy) - k1_n10_0*uy + k1_n11_0*(1-uy)
    k2_0_10  = k1_0n1_0*(n1-uy)  - k1_00_0*uy  + k1_01_0*(1-uy)
    k2_1_10  = k1_1n1_0*(n1-uy)  - k1_10_0*uy  + k1_11_0*(1-uy)

    k2_n1_11 = k1_n1n1_1*(n1-uy) - k1_n10_1*uy + k1_n11_1*(1-uy)
    k2_0_11  = k1_0n1_1*(n1-uy)  - k1_00_1*uy  + k1_01_1*(1-uy)
    k2_1_11  = k1_1n1_1*(n1-uy)  - k1_10_1*uy  + k1_11_1*(1-uy)

    k2_n1_12 = k1_n1n1_2*(n1-uy) - k1_n10_2*uy + k1_n11_2*(1-uy)
    k2_0_12  = k1_0n1_2*(n1-uy)  - k1_00_2*uy  + k1_01_2*(1-uy)
    k2_1_12  = k1_1n1_2*(n1-uy)  - k1_10_2*uy  + k1_11_2*(1-uy)


    k2_n1_20 = k1_n1n1_0*(n1-uy)**2 + k1_n10_0*(-uy)**2 + k1_n11_0*(1-uy)**2
    k2_0_20  = k1_0n1_0*(n1-uy)**2  + k1_00_0*(-uy)**2  + k1_01_0*(1-uy)**2
    k2_1_20  = k1_1n1_0*(n1-uy)**2  + k1_10_0*(-uy)**2  + k1_11_0*(1-uy)**2

    k2_n1_21 = k1_n1n1_1*(n1-uy)**2 + k1_n10_1*(-uy)**2 + k1_n11_1*(1-uy)**2
    k2_0_21  = k1_0n1_1*(n1-uy)**2  + k1_00_1*(-uy)**2  + k1_01_1*(1-uy)**2
    k2_1_21  = k1_1n1_1*(n1-uy)**2  + k1_10_1*(-uy)**2  + k1_11_1*(1-uy)**2

    k2_n1_22 = k1_n1n1_2*(n1-uy)**2 + k1_n10_2*(-uy)**2 + k1_n11_2*(1-uy)**2
    k2_0_22  = k1_0n1_2*(n1-uy)**2  + k1_00_2*(-uy)**2  + k1_01_2*(1-uy)**2
    k2_1_22  = k1_1n1_2*(n1-uy)**2  + k1_10_2*(-uy)**2  + k1_11_2*(1-uy)**2
