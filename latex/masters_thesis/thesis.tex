...
{\Huge
  A cumulant-based Lattice Boltzmann method in two dimensions
}
\bigskip
...
Der Fokus liegt auf einer ausf\"urlichen Darstellung der vorgestellten Methode, um den Zugang zum Gebiet der Lattice-Boltzmann Methoden zu erleichtern.
...
Die folgenden Abschnitte~\ref{sec: Series expansions} bis~\ref{sec: Momentum equations} widmen sich ausschließlich der Analyse der dargestellten Methode.
