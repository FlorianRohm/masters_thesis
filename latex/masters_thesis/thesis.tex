...
Dazu wird in Sektion~\ref{sec: History of Lattice Boltzmann} die Geschichte der Lattice-Boltzmann Methoden dargelegt, bevor in Sektion~\ref{sec: Lattice Boltzmann basics} die Hintergr\"unde der Methoden hergeleitet werden und die Benutzung von Kumulanten motiviert wird.
...
Zu guter Letzt werden in~\ref{sec: Numerics} Resultate numerischer Tests aufgef\"uhrt, welche die Methode bez\"uglich Geschwindigkeit, Genauigkeit und Stabilit\"at testen.
