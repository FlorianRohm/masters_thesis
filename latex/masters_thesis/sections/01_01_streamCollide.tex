...
The full derivation can be found in Appendix~\ref{sec: Lattice Boltzmann Equation}.

Now, we can finally introduce the most known keywords asociated to LBM:\@ stream and collide.
...
Although not yet specified, it will relax the distributions to local equilibrium in a certain sense, as motivated in Section~\ref{sec: History of Lattice Boltzmann}. This will be discussed in Section~\ref{sub: The issue with relaxation rates}.
\todo[inline]{picture?}
