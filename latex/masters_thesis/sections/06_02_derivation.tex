...
In our case though, this is not needed.} for $m_{30}$, c.f.~\eqref{eq:aliasing of moments 1}\footnote{Keep in mind, that we rescaled the moments making the aliasing a one to one relationship without the $c$.}, and the identities~\eqref{eq: eq moments 21_1}
...
\end{align}
to see that those are just the second order convective terms of~\eqref{eq: navier stokes goal}.
