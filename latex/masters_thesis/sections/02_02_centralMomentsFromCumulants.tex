...
The calculation of those from our \glspl{pdf} can be done in an efficient way as shown in~\ref{sub: Fast central moment transformation},
...
\begin{equation}
  ...
  \begin{aligned}
    ...
    & = \sum_{\alpha,\beta} \Bigg(
        \frac{1}{\alpha!\beta!} {(-c)}^{\alpha+\beta} \sum_{i,j} {\left(i+\frac{u_1}{c}\right)}^\alpha {\left(j+\frac{u_2}{c}\right)}^\beta f_{ij} e^{-\Xi_1 ic} e^{-\Xi_2 jc}
...
\begin{equation}
  \begin{aligned}
    ...
    L_1\bigr|_{\Xi_1=\Xi_2 = 0} & = \bigg(
      \underbrace{ \partial_1\ln(F) \bigr|_{\Xi_1=\Xi_2 = 0}}_{ = c\kappa_{10} = c\frac{m_{10}}{m_{00}}}
      - \underbrace{u_1}_{ = c\frac{m_{10}}{m_{00}}} \bigg) = 0 \\
