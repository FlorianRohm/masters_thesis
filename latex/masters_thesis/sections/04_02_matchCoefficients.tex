...
\begin{equation}
  \partial_t \defined \frac{\partial}{\partial t}, \quad
  \partial_x \defined \frac{\partial}{\partial x}, \quad
  \partial_y \defined \frac{\partial}{\partial y}, \quad
  \partial_{xx} \defined \frac{\partial^2}{{\partial x}^2}, \quad
  \partial_{yx} \defined \frac{\partial\partial}{\partial x\partial y}, \quad
  \partial_{yy} \defined \frac{\partial^2}{{\partial x}^2}
\end{equation}
...
For the first order terms, one has to choose $p=1$ and $\iota=0$ on the left side and one of $m$, $n$ and $p'$ equal to one, the other two equal to zero.
