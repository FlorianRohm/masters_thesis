...
Figure~\ref{fig: vortex merge setup} depicts the most simple nontrivial setting consisting of two vortices next to each other with the same direction of rotation, in our case conterclockwise, i.e.\ with positive vorticity.
...
With this in mind, the results from Figure~\ref{fig: rankine cumulant all} look that much astonishing than they did at the beginning.
