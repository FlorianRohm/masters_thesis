...
The \gls{lbm} is a vital part of todays \gls{cfd} landscape, despite being a relatively new method. It's competing with Finite-Element/Volume/Differences methods even in the conservative field of commercial fluid dynamics software.
