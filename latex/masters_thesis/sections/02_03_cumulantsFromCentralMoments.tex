...
The first three can not be inverted but have to be computed from the moments $m_{00}$, $m_{10}$ and $m_{01}$ which we need anyway for the central moment computation.
All other but the last equation are inverted straightforward.
