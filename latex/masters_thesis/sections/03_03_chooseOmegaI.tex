...
With the cell spacing set to one, $c=1$ and the speed of sound for the D2Q9\todo[inline]{cite}\todo[inline]{speed of sound nachfragen} calculated as  $c_s^2=\frac{1}{3}$ we get
\begin{equation}
