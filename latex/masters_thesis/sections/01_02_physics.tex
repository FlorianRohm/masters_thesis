...
\end{equation}
From the relations in~\eqref{eq: physical quantities continuous moments}, we can also conclude, that centralized moments are just like normal moments, but seen from a frame of reference moving with the flow velocity $\vec{u}$.
...
\end{equation}
The full list of independent moments together with the first dependent moments of the D2Q9 stencil according to~\eqref{eq:aliasing of moments 1} and~\eqref{eq:aliasing of moments 2} is displayed in Table~\ref{table:D2Q9 moments}.
